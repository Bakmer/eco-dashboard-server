...
export class Migration1612384613233 implements MigrationInterface {
    name = 'Migration1612384613233'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `clients` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `last_name` varchar(255) NOT NULL, `razon_social` varchar(255) NOT NULL, `cuit` int NOT NULL, `iva` varchar(255) NOT NULL, `email` varchar(255) NOT NULL, `phone_1` int NOT NULL, `phone_2` int NULL, `phone_3` int NULL, `address_1` varchar(255) NOT NULL, `address_2` varchar(255) NULL, `address_3` varchar(255) NULL, `memo` varchar(255) NOT NULL, `storeId` int NOT NULL, `statusId` int NOT NULL, `userId` int NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX `IDX_8c5a7225086f3f422b7b5de03a` (`cuit`), UNIQUE INDEX `IDX_b48860677afe62cd96e1265948` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
